...
namespace Capa_Presentacion.Formularios
{
    public partial class frmRegClientes : Form
    {
                ...
                if (Mensaje.MostraPreguntaSiNo("¿Quiere dar de alta a cliente "+ cliente.PrimerNombre +" " + cliente.PrimerApellido +"?", "Alta de cliente"))
                {
                    ...
                    if (retorno > 0)
                    {
                        ...
                        if (alta.darAltaTelefonos(persona))
                        {
                            ...
                            {
                                Mensaje.MostrarInfo("El Cliente que intenta dar de alta ya se encuentra registrado", "Aviso en alta Cliente");
                            }
                            //Si dio Error
                            else
                            {
                    ...
                    {
                        Mensaje.MostrarInfo("La Persona que intenta dar de alta ya se encuentra registrada", "Aviso en alta Persona");
                    }
                    //Y -1 si es error
                    else
                    {
        ...
        {
            if (Mensaje.MostraPreguntaSiNo("¿Quiere vaciar los campos?", "Vaciar campos"))
            {
        ...
        private void btnLimpiar_Click(object sender, EventArgs e)
        {
            ...
            {
                if (Mensaje.MostraPreguntaSiNo("¿Quiere borrar las filas de la tabla", "Borrar tabla"))
                {
                    //Limpio los componenetes
